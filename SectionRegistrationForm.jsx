...
//Мы старались 2 дня, надеемся, что вам понравится, если что-то не так, то сразу напишите (￣o￣) . z Z
...
const RegistrationForm = () => {
  const handleSubmit = (e) => {
    ...
    if (e.target.checkValidity()) {
      window.location.href = 'ССЫЛКА НА САЙТ';// o(*￣︶￣*)o
    }
  };

  const handleLoginClick = (e) => {
    e.preventDefault();
    window.location.href = '/login';//d=====(￣▽￣*)b
  };
  ...
  return (
    <section className="registration-container">
      ...
      <div className="image-section">
        <img src="OBJECTS.svg" alt="Background" className="background-image" />
      </div>
    </section>
  );
};
